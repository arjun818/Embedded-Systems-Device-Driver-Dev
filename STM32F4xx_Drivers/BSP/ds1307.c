...
I2C_Handle g_DS1307_I2C_Handle;
...
void DS1307_SetCurrentTime(RTC_Time_t *RTC_Time)
{
    ...
    if(RTC_Time->time_format == TIME_FORMAT_24HRS) {
        ...
        if(RTC_Time->time_format == TIME_FORMAT_12HRS_PM) {
            ...
            hours &= ~(1 << 5); //TIME_FORMAT_12HRS_AM
        }
    }
...
static void DS1307_I2C_PinConfig(void)
{
    ...
    I2CPins.GPIO_PinConf.GPIO_PinPuPdControl = DS1307_I2C_PUPD;
    I2CPins.GPIO_PinConf.GPIO_PinSpeed = GPIO_OP_TYPE_MS;

    /* SCL */
    I2CPins.GPIO_PinConf.GPIO_PinNumber = DS1307_I2C_SCL_PIN;
    GPIO_init(&I2CPins);

    /* SDA */
    I2CPins.GPIO_PinConf.GPIO_PinNumber = DS1307_I2C_SDA_PIN;
    GPIO_init(&I2CPins);
}
