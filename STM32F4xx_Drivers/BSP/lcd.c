...
void LCD_Init(void)
{
    ...
    LCD_Signal.GPIO_PinConf.GPIO_PinMode = GPIO_MODE_OUT;
    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_RS;
    LCD_Signal.GPIO_PinConf.GPIO_PinOpType = GPIO_OP_TYPE_PP;
    LCD_Signal.GPIO_PinConf.GPIO_PinPuPdControl = GPIO_NO_PUPD;
    LCD_Signal.GPIO_PinConf.GPIO_PinSpeed = GPIO_OP_TYPE_MS;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_RW;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_EN;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D4;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D5;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D6;
    GPIO_init(&LCD_Signal);

    LCD_Signal.GPIO_PinConf.GPIO_PinNumber = LCD_GPIO_D7;
    GPIO_init(&LCD_Signal);


    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_RS, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_RW, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_EN, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_D4, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_D5, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_D6, GPIO_PIN_RESET);
    GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_D7, GPIO_PIN_RESET);
...
{
    /* RS = 1 for User Data */
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_RS, GPIO_PIN_SET);
...
static void Write4Bits(uint8_t value)
{
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT,LCD_GPIO_D4, ((value >> 0) & 0x1) );
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT,LCD_GPIO_D5, ((value >> 1) & 0x1) );
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT,LCD_GPIO_D6, ((value >> 2) & 0x1) );
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT,LCD_GPIO_D7, ((value >> 3) & 0x1) );
...
static void LCD_Enable(void)
{
	GPIO_WriteFromOutputPin(LCD_GPIO_PORT, LCD_GPIO_EN, GPIO_PIN_SET);
    Delay_us(10);
