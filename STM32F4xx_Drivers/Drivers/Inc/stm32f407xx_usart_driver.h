...
typedef struct
{
	USART_reg *pUSARTx;            /*!< This holds the base address of the USARTx (x : 1,2,3) peripheral >*/
	USART_Config   USART_Config;		/*!< This Configurational details of the USARTx (x : 1,2,3) peripheral >*/
	...
	uint8_t TxBusyState;				/*!< To store Tx State, Possible values from @USART_APP_STATE >*/
	uint8_t RxBusyState;				/*!< To store Rx State, Possible values from @USART_APP_STATE >*/
}USART_Handle;
 ...
 */
void USART_PeriClockControl(USART_reg *pUSARTx, uint8_t EnOrDi);
...
uint8_t USART_GetFlagStatus(USART_reg *pUSARTx, uint8_t StatusFlagName);
void USART_ClearFlag(USART_reg *pUSARTx, uint16_t StatusFlagName);
void USART_PeripheralControl(USART_reg *pUSARTx, uint8_t EnOrDi);
void USART_SetBaudRate(USART_reg *pUSARTx, uint32_t BaudRate);
