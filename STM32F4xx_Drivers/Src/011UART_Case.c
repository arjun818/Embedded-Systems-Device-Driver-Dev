...
char *msg[3] = {"hihihihihihi123", "Hello Acha, amma and Udit How are you? ?" , "Today is Saturday just working on some random projects!!"};
...
void USART2_GPIOInit(void)
{
	...
	usart_gpios.GPIO_PinConf.GPIO_PinSpeed = GPIO_OP_TYPE_MS;
...
void GPIO_ButtonInit(void)
{
	...
	GPIOBtn.GPIO_PinConf.GPIO_PinSpeed = GPIO_OP_TYPE_MS;
	...
	GpioLed.GPIO_PinConf.GPIO_PinSpeed = GPIO_OP_TYPE_MS;
